...
$demo_url    = "https://themes.designorbital.com/fresh-blog/";
      ...
      <div class="welcome-panel-column-container">
        <div class="welcome-panel-column">
          ...
          <div class="welcome-panel-column-content">
            ...
            <p><?php esc_html_e('Use discount code WPLOVE to upgrade to the Pro theme or bundle and unlock premium features at a special price.', 'fresh-blog-lite'); ?></p>
          </div>
        </div>
        <div class="welcome-panel-column">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
          ...
          <div class="welcome-panel-column-content">
            <h3><?php esc_html_e('150+ Predesigned Patterns', 'fresh-blog-lite'); ?></h3>
            <p><?php esc_html_e('Access 150+ professionally designed patterns to quickly build beautiful, responsive layouts for any type of website effortlessly.', 'fresh-blog-lite'); ?></p>
          </div>
        </div>
        <div class="welcome-panel-column">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
          ...
          <div class="welcome-panel-column-content">
            <h3><?php esc_html_e('25+ Blocks & Extensions', 'fresh-blog-lite'); ?></h3>
            <p><?php esc_html_e('Enhance your site with 25+ powerful blocks and extensions, adding advanced functionality, flexibility, and seamless customization options.', 'fresh-blog-lite'); ?></p>
          </div>
        </div>
      </div>
    </div>
